...
public class UsuarioControllerTest {
	...
	@Test
	@Order(5)
	@DisplayName("buscar um usuario pelo Id")
	public void mostrarUsuarioPeloId () {
		Optional<Usuario> usuarioBusca = usuarioService.cadastrarUsuario(new Usuario(0L, 
				"Daniel Gardeli", "Gardeli@email.com.br", "gardeli12345", "https://i.imgur.com/EcJG8kB.jpg"	));
	...
	public void deveAutenticarUsuario() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L, 
				"Maria Antonia", "Maria-antonia@email.com.br", "20304060", "https://i.imgur.com/T12NIp9.jpg"));
		
		HttpEntity<UsuarioLogin> corpoRequisicao = new HttpEntity<UsuarioLogin>(new UsuarioLogin(0L, 
				"", "Maria-antonia@email.com.br", "20304060", "", ""));
